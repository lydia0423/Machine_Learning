...
class bwDB:
    def __init__(self, **kwargs):
        #serve as a docuemntation for that function, method or class
        """
    ...
    def _filename(self, fn):
        ...
        #row_factory: allow user to read data in different ways
...
def test():
    ...
    print(f'There are {db.countrecs()} rows')
    for r in db.getrecs():
        #can change the data representation are here as row_factory has been used in the previous section
        #dictionary, list ot tuple style
        print(dict(r))
